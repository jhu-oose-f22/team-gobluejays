...
12. Setting page: as a user, when I log in, there should be a setting page containing my personal profile information and have access to project document and support.
...
3. Log-in: as a user of the app, I want to be able to sign up/login to the app so that I can access to my personal data securely and don’t need to re-enter every time.
...
5. Integrated notifications: as a user of the app, I want to be able to receive notifications from multiple embedded apps and webs altogether so that I can be better informed.
6. Personalization: as a user of the app, I want to be able to personalize my app settings such as profile image and background so that I can enjoy the customized experience.
7. Order Foods: as a user of the app, I want to be able to order or schedule foods and drinks online from Brody Cafe etc. so that I don’t need to always line up and can pick up my orders sometimes.
8. Classmates and study group: as a user of the app, I want to be able to find classmates and form study groups so that I have the chance to better know about and work with my peers.
9. One-time log-in: as a user of the app, I want to be able to login to the app using my school email account and don’t need to re-login to other embedded apps and websites so that I only need to login once.
